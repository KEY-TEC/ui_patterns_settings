...
use Drupal\ui_patterns_settings\Plugin\PatternSourceBase;
use Drupal\ui_patterns_settings\UiPatternsSettings;
use Drupal\ui_patterns_settings\UiPatterns;

/**
 * Trait PatternDisplayFormTrait.
 *
 * @property \Drupal\ui_patterns_settings\UiPatternsManager $patternsManager
 * @property \Drupal\ui_patterns_settings\UiPatternsSourceManager $sourceManager
 * @method \Drupal\Core\StringTranslation\TranslatableMarkup t($string, array $args = [], array $options = [])
 *
 * @package Drupal\ui_patterns_settings\Form
 */
trait PatternDisplayFormTrait {
  ...
  public function buildPatternDisplayForm(array &$form, $tag, array $context, array $configuration) {
    ...
    /** @var \Drupal\ui_patterns_settings\Definition\PatternDefinition $definition */
  ...
  public function getMappingForm($pattern_id, $tag, array $context, array $configuration) {
    /** @var \Drupal\ui_patterns_settings\Definition\PatternDefinition $pattern */
